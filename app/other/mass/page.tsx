...
export const metadata: Metadata = {
  title: 'Mass Calculator | zenicalculator',
  description: 'Convert and calculate mass between different units.',
};
  ...
  return (
    <main className="pt-24 px-4 md:px-8 lg:px-16 max-w-5xl mx-auto space-y-10">
      <section className="text-center">
        <h1 className="text-3xl md:text-4xl font-bold text-blue-700 mb-3">Mass Calculator</h1>
        <p className="text-gray-700 text-base md:text-lg">Convert and calculate mass between different units.</p>
      </section>
