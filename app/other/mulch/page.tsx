...
export const metadata: Metadata = {
  title: 'Mulch Calculator | zenicalculator',
  description: 'Calculate how much mulch you need for your garden.',
};
  ...
  return (
    <main className="pt-24 px-4 md:px-8 lg:px-16 max-w-5xl mx-auto space-y-10">
      <section className="text-center">
        <h1 className="text-3xl md:text-4xl font-bold text-green-700 mb-3">Mulch Calculator</h1>
        <p className="text-gray-700 text-base md:text-lg">Calculate how much mulch you need for your garden.</p>
      </section>
