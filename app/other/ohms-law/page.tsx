  ...
  return (
    <main className="pt-24 px-4 md:px-8 lg:px-16 max-w-5xl mx-auto space-y-10">
      <section className="text-center">
        <h1 className="text-3xl md:text-4xl font-bold text-red-700 mb-3">Ohm's Law Calculator</h1>
        <p className="text-gray-700 text-base md:text-lg">Calculate voltage, current, or resistance using Ohm's Law (V = I × R).</p>
      </section>
