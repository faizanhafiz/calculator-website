const StaticContent = () => {
  return (
    <section className="bg-white rounded-xl shadow p-6 space-y-6">
      <h2 className="text-2xl font-semibold text-blue-700">Perimeter Formulas for Common Shapes</h2>
      <p className="text-lg text-gray-700">Perimeter is the total distance around the boundary of a two-dimensional shape. It is measured in linear units (meters, feet, inches) and is essential for tasks like fencing a yard, framing a picture, or laying a border around a garden.</p>
