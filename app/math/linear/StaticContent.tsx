const StaticContent = () => {
  return (
    <section className="bg-white rounded-xl shadow p-6 space-y-6">
      <h2 className="text-2xl font-semibold text-blue-700">Solving Linear Equations</h2>
      <p className="text-lg text-gray-700">Linear equations are algebraic equations where each variable has an exponent of 1. They produce a straight line when graphed and are the most commonly encountered type of equation in mathematics, physics, economics, and everyday problem-solving.</p>
