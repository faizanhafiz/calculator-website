const StaticContent = () => {
  return (
    <section className="bg-white rounded-xl shadow p-6 space-y-6">
      <h2 className="text-2xl font-semibold text-blue-700">Understanding Decimal Numbers</h2>
      <p className="text-lg text-gray-700">Decimal numbers are a way to express fractions and mixed numbers using base-10 notation. The decimal point separates the whole number part from the fractional part. Decimals are used in money, measurements, and most scientific calculations.</p>
