const StaticContent = () => {
  return (
    <section className="bg-white rounded-xl shadow p-6 space-y-6">
      <h2 className="text-2xl font-semibold text-blue-700">Introduction to Algebra</h2>
      <p className="text-lg text-gray-700">Algebra is the branch of mathematics that uses symbols and letters to represent numbers and quantities in equations. It is foundational to all advanced mathematics, science, engineering, and economics. Our algebra calculator helps solve expressions and equations step by step.</p>
